...
<head>
  ...
  <style>
  body { margin: 0; padding: 20px; margin: 1em; background-color: #eee }
  body, td, th { font: 12px Verdana, Arial, sans-serif; color: #333 }
  a { color: #333 }
...
<body id="exception">
  <div id="content">
    ...
    <h1>[<?php echo $name ?>]</h1>
    <h2 id="message"><?php echo htmlspecialchars($message, ENT_QUOTES, sfConfig::get('sf_charset', 'UTF-8')) ?></h2>
    <h2>stack trace <a href="#" onclick="toggle('sf_stack_trace'); return false;">...</a></h2>
    <div id="sf_stack_trace"><ul><li><?php echo implode('</li><li>', $traces) ?></li></ul></div>

    <h2>symfony settings <a href="#" onclick="toggle('sf_settings'); return false;">...</a></h2>
    <div id="sf_settings"><?php echo $settingsTable ?></div>

    <h2>request <a href="#" onclick="toggle('sf_request'); return false;">...</a></h2>
    <div id="sf_request"><?php echo $requestTable ?></div>
    ...
    <p id="footer">
      symfony <?php echo SYMFONY_VERSION ?> - php <?php echo PHP_VERSION ?><br />
