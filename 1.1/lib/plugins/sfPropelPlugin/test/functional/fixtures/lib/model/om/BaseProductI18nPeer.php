...
abstract class BaseProductI18nPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$stmt = ProductI18nPeer::doSelectStmt($criteria, $con);
	...
	public static function getPrimaryKeyHashFromRow($row, $startcol = 0)
	{
		...
		return serialize(array((int) $row[$startcol + 0], (string) $row[$startcol + 1]));
	}
	...
	public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(ProductI18nPeer::ID, ProductPeer::ID, Criteria::LEFT_JOIN);
	...
	public static function doSelectJoinProduct(Criteria $c, $con = null)
	{
		...
		$c->addJoin(ProductI18nPeer::ID, ProductPeer::ID, Criteria::LEFT_JOIN);
