...
/**
 * sfApplicationConfiguration represents a configuration for a symfony application.
 *
 * @package    symfony
 * @subpackage config
...
abstract class sfApplicationConfiguration extends ProjectConfiguration
{
  ...
  public function checkSymfonyVersion()
  {
    ...
    if (!sfConfig::get('sf_debug') && !sfConfig::get('sf_test') && (SYMFONY_VERSION != @file_get_contents(sfConfig::get('sf_config_cache_dir').DIRECTORY_SEPARATOR.'VERSION')))
    {
      // clear cache
