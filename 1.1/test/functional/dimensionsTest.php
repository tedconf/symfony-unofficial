...
$t->is(sfLoader::getConfigPaths('config/view.yml'), array($sf_symfony_lib_dir.'/config/config/view.yml',  $path.'/plugins/sfConfigPlugin/config/view.yml', $path.'/config/view.yml', $path.'/apps/'.$app.'/config/view.yml',  $path.'/apps/'.$app.'/config/fr/view.yml'), ' returns valid config dirs for view.yml in culture => fr dimension');
...
$t->is(sfLoader::getControllerDirs('dimensions'), array($path.'/apps/'.$app.'/modules/dimensions/actions/fr' => false,  $path.'/apps/'.$app.'/modules/dimensions/actions' => false,  $sf_symfony_lib_dir.'/controller/dimensions/actions' => true), ' returns valid controller dirs for dimensions controller in culture => fr dimension');
