...
// ->initialize()
$t->diag('->initialize()');
$i18n = new sfI18N($dispatcher, array('cache' => $cache));
...
$i18n = new sfI18N($dispatcher, array('cache' => $cache, 'culture' => 'fr'));
...
// debug
$i18n = new sfI18N($dispatcher, array('cache' => $cache, 'debug' => true));
$t->is($i18n->__('unknown'), '[T]unknown[/T]', '->__() adds a prefix and a suffix on untranslated strings if debug is on');
$i18n = new sfI18N($dispatcher, array('cache' => $cache, 'debug' => true, 'untranslated_prefix' => '-', 'untranslated_suffix' => '#'));
