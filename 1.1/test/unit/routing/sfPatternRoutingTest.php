...
// no route matches
$t->diag('no matched routed');
$r->clearRoutes();
try
{
  $r->parse('/test');
  $t->fail('->parse() routes that do not match throw sfError404Exception');
}
catch (sfError404Exception $e)
{
  $t->pass('->parse() routes that do not match throw sfError404Exception');
}
