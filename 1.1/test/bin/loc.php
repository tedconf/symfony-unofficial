...
// symfony core LOC
$total_loc = 0;
$files = sfFinder::type('file')->name('*.php')->prune('vendor')->in($root_dir.'/lib');
...
// symfony tests LOC
$total_tests_loc = 0;
$files = sfFinder::type('file')->name('*Test.php')->in(array($root_dir.'/test/unit', $root_dir.'/test/functional', $root_dir.'/test/other'));
foreach ($files as $file)
{
