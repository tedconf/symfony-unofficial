...
class sfDoctrineFormFilterGenerator extends sfDoctrineFormGenerator
{
  ...
  public function generate($params = array())
  {
    ...
    $file = sfConfig::get('sf_lib_dir').'/filter/doctrine/base/BaseFormFilterDoctrine.class.php';
    if (!file_exists($file))
    {
    ...
    foreach ($models as $model)
    {
      ...
      {
        $pluginBaseDir = sfConfig::get('sf_plugins_dir') . '/' . $this->getPluginNameForModel($model) . '/lib/filter/doctrine';
