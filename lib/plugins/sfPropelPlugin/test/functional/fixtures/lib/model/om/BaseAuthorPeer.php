...
abstract class BaseAuthorPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
		  require_once 'lib/model/map/AuthorMapBuilder.php';
	 ...
	 * @param      string $column The column name for current table. (i.e. AuthorPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Author $value A Author object.
	 ...
	 * @return     Author Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    foreach (sfMixer::getCallables('BaseAuthorPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Author object
		}

		$criteria->remove(AuthorPeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Validates all modified columns of given Author object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Author $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the AuthorPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AuthorPeer class:
//
// Propel::getDatabaseMap(AuthorPeer::DATABASE_NAME)->addTableBuilder(AuthorPeer::TABLE_NAME, AuthorPeer::getMapBuilder());
//
