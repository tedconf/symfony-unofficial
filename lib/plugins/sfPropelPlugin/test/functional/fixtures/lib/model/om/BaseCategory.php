...
abstract class BaseCategory extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = CategoryPeer::NUM_COLUMNS - CategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Temporary storage of collArticles to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 *
	 * @return     void
	 * @deprecated - This method will be removed in 2.0 since arrays
	 *				are automatically initialized in the addArticles() method.
	 * @see        addArticles()
	 */
	 ...
	 * related Articles from storage. If this Category is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getArticles($criteria = null, PDO $con = null)
	{
	...
	/**
	 * Returns the number of related Articles.
	 *
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function countArticles($criteria = null, $distinct = false, PDO $con = null)
	{
	...
	{
		$this->collArticles = (array) $this->collArticles;
