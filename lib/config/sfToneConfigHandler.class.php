...
class sfToneConfigHandler extends sfYamlConfigHandler
{
  ...
  protected function parseToneDefinition($name, $toneDef)
  {
    ...
    if (!empty($toneDef['init_args']) && is_array($toneDef['init_args']))
    {
      $def['init_args'] = $toneDef['init_args'];
    }
    ...
    if (isset($toneDef['preload']))
    {
      $def['preload'] = $toneDef['preload'];
    }

    if (!empty($toneDef['load_condition']))
    {
      $def['load_condition'] = $toneDef['load_condition'];
    }
