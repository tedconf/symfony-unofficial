...
/**
 * The sfLog_win class is a concrete implementation of the sfLog abstract
...
class sfLog_win extends sfLog
{
     ...
     * @access private
     */
    var $_title = 'sfLog Output Window';
                          ...
                          $level = PEAR_LOG_DEBUG)
    {
        ...
        register_shutdown_function(array(&$this, '_sfLog_win'));
    }
