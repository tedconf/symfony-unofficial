...
class sfBasicSecurityUser extends sfUser implements sfSecurityUser
{
  ...
  public function hasCredential($credential)
  {
    if (is_array($credential))
    {
      ...
      return $this->checkCredentials($credentials, true);
    }
    else
    {
  ...
  private function checkCredentials($credentials, $matchAll)
  {
    ...
    foreach($credentials as $credential)
    {
      ...
      if(!is_array($credential)) sfContext::getInstance()->getLogger()->info('checking credential '.$credential.', was '.$hasCredential);
