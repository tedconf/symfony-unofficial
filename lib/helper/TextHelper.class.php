 ...
 */
class TextHelper extends sfHelper
{
  const SF_AUTO_LINK_RE = '/
    (                       # leading text
 ...
 * @version    SVN: $Id: TextHelper.php 1415 2006-06-11 08:33:51Z fabien $
 */
 ...
 */
static function highlight_text($text, $phrase, $highlighter = '<strong class="highlight">\\1</strong>')
{
  if ($text == '')
  {
    return '';
 ...
 */
static function excerpt_text($text, $phrase, $radius = 100, $excerpt_string = '...')
{
  if ($text == '')
  {
    return '';
 ...
 */
static function wrap_text($text, $line_width = 80)
{
...
*/
static function simple_format_text($text, $options = array())
{
 ...
 */
static function auto_link_text($text, $link = 'all', $href_options = array())
{
  if ($link == 'all')
  {
 ...
 */
static function strip_links_text($text)
{
 ...
 */
static function _auto_link_urls($text, $href_options = array())
{
  $href_options = _tag_options($href_options);
  return preg_replace_callback(
    self::SF_AUTO_LINK_RE,
 ...
 */
static function _auto_link_email_addresses($text)
{
