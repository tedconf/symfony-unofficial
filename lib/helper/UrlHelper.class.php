 ...
 * @version    SVN: $Id: UrlHelper.php 2064 2006-09-13 15:05:15Z fabien $
 */
 ...
 */
static function url_for($internal_uri, $absolute = false)
{
  static $controller;
 ...
 * @see    url_for
 */
static function link_to($name = '', $internal_uri = '', $options = array())
{
 ...
 * @see    link_to
 */
static function link_to_if($condition, $name = '', $internal_uri = '', $options = array())
{
  if ($condition)
  {
 ...
 * @see    link_to
 */
static function link_to_unless($condition, $name = '', $url = '', $options = array())
{
 ...
 * @see    url_for, link_to
 */
static function button_to($name, $internal_uri, $options = array())
{
 ...
 * @see    link_to
 */
static function mail_to($email, $name = '', $options = array())
{
  $html_options = _parse_attributes($options);
...
static function _convert_options_to_javascript($html_options, $internal_uri = '')
{
  // confirm
...
static function _confirm_javascript_function($confirm)
{
  return "confirm('".escape_javascript($confirm)."')";
}

static function _popup_javascript_function($popup, $internal_uri = '')
{
