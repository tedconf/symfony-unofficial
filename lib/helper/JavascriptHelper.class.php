 ...
 * @version    SVN: $Id: JavascriptHelper.php 2060 2006-09-13 11:26:30Z fabien $
 */
class JavascriptHelper extends sfHelper
{
 ...
 */
  ...
  static function get_ajax_options()
  {
    static $ajax_options;
    if (!$ajax_options)
    {
   ...
   *
   */
  static function button_to_remote($name, $options = array(), $html_options = array())
  {
   ...
   */
  static function link_to_remote($name, $options = array(), $html_options = array())
  {
   ...
   */
  static function periodically_call_remote($options = array())
  {
   ...
   */
  static function form_remote_tag($options = array(), $options_html = array())
  {
   ...
   */
  static function submit_to_remote($name, $value, $options = array(), $options_html = array())
  {
    $options = _parse_attributes($options);
    $options_html = _parse_attributes($options_html);
   ...
   *  )) ?>
   */
  static function update_element_function($element_id, $options = array())
  {
   ...
   */
  static function evaluate_remote_response()
  {
   ...
   *   </select>
   */
  static function remote_function($options)
  {
    sfContext::getInstance()->getResponse()->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
   ...
   * link_to_remote().
   */
  static function observe_field($field_id, $options = array())
  {
    sfContext::getInstance()->getResponse()->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
   ...
   */
  static function observe_form($form_id, $options = array())
  {
    sfContext::getInstance()->getResponse()->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
   ...
   */
  static function visual_effect($name, $element_id = false, $js_options = array())
  {
   ...
   * http://script.aculo.us for more documentation.
   */
  static function sortable_element($element_id, $options = array())
  {
    $response = sfContext::getInstance()->getResponse();
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/builder');
   ...
   * http://script.aculo.us for more documentation.
   */
  static function draggable_element($element_id, $options = array())
  {
    $response = sfContext::getInstance()->getResponse();
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/builder');
   ...
   * http://script.aculo.us for more documentation.
   */
  static function drop_receiving_element($element_id, $options = array())
  {
    $response = sfContext::getInstance()->getResponse();
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/builder');
   ...
   */
  static function input_auto_complete_tag($name, $value, $url, $tag_options = array(), $completion_options = array())
  {
   ...
   */
  static function input_in_place_editor_tag($name, $url, $editor_options = array())
  {
    $response = sfContext::getInstance()->getResponse();
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/effects');
   ...
   * is switched on.
   */
  static function end_if_javascript()
  {
   ...
   */
  static function _auto_complete_field($field_id, $url, $options = array())
  {
  ...
  static function _options_for_ajax($options)
  {
  ...
  static function _method_option_to_s($method)
  {
    return (is_string($method) && $method[0] != "'") ? "'$method'" : $method;
  }

  static function _build_observer($klass, $name, $options = array())
  {
  ...
  static function _build_callbacks($options)
  {
    $callbacks = array();
