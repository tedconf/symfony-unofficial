 ...
 * @version    SVN: $Id: AssetHelper.php 1955 2006-09-05 15:42:45Z fabien $
 */
class AssetHelper extends sfHelper
{
 ...
 */
static function auto_discovery_link_tag($type = 'rss', $url_options = array(), $tag_options = array())
{
 ...
 */
static function javascript_path($source, $absolute = false)
{
 ...
 * @see    javascript_path 
 */
static function javascript_include_tag()
{
  $html = '';
 ...
 * @see    stylesheet_tag  
 */
static function stylesheet_path($source, $absolute = false)
{
 ...
 * @see    stylesheet_path 
 */
static function stylesheet_tag()
{
 ...
 */
static function use_stylesheet($css, $position = '', $options = array())
{
 ...
 */
static function use_javascript($js, $position = '')
{
 ...
 * @see    image_tag  
 */
static function image_path($source, $absolute = false)
{
 ...
 * @see    image_path 
 */
static function image_tag($source, $options = array())
{
  if (!$source)
  {
    return '';
...
static function _compute_public_path($source, $dir, $ext, $absolute = false)
{
  if (strpos($source, '://'))
  {
    return $source;
 ...
 * @see    include_metas 
 */
static function include_http_metas()
{
