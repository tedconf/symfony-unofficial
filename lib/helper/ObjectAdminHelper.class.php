 ...
 */
class ObjectAdminHelper extends sfHelper
{
 ...
 * @version    SVN: $Id: ObjectAdminHelper.php 2011 2006-09-08 11:05:31Z fabien $
 */

static function object_admin_input_file_tag($object, $method, $options = array())
{
...
static function object_admin_double_list($object, $method, $options = array())
{
  $options = _parse_attributes($options);
...
static function object_admin_select_list($object, $method, $options = array())
{
  $options = _parse_attributes($options);
...
static function object_admin_check_list($object, $method, $options = array())
{
  $options = _parse_attributes($options);
