 ...
 * @version    SVN: $Id: ObjectHelper.php 1908 2006-08-31 12:15:24Z fabien $
 */
class ObjectHelper extends sfHelper
{
 ...
 *
 */
static function object_input_date_tag($object, $method, $options = array(), $default_value = null)
{
 ...
 *
 */
static function object_textarea_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
 ...
 */
static function objects_for_select($options = array(), $value_method, $text_method = null, $selected = null, $html_options = array())
{
 ...
 *
 */
static function object_select_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
...
static function _get_values_for_object_select_tag($object, $class, $text_method = null, $peer_method = null)
{
...
static function _get_options_from_objects($objects, $text_method = null)
{
  $select_options = array();
...
static function object_select_country_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
...
static function object_select_language_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
 ...
 *
 */
static function object_input_hidden_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
 ...
 *
 */
static function object_input_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
 ...
 *
 */
static function object_checkbox_tag($object, $method, $options = array(), $default_value = null)
{
  $options = _parse_attributes($options);
...
static function _convert_method_to_name ($method, &$options)
{
...
static function _get_object_value ($object, $method, $default_value = null, $param = null)
{
  // method exists?
