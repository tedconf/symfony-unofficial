 ...
 * @version    SVN: $Id: FormHelper.php 2018 2006-09-08 21:39:43Z pookey $
 */
class FormHelper extends sfHelper
{
 ...
 * @see select_tag
 */
static function options_for_select($options = array(), $selected = '', $html_options = array())
{
 ...
 */
static function form_tag($url_for_options = '', $options = array())
{
 ...
 */
static function select_tag($name, $option_tags = null, $options = array())
{
 ...
 */
static function select_country_tag($name, $value, $options = array())
{
 ...
 * @see select_tag, options_for_select, sfCultureInfo
 */
static function select_language_tag($name, $value, $options = array())
{
  $c = new sfCultureInfo(sfContext::getInstance()->getUser()->getCulture());
 ...
 */
static function input_tag($name, $value = null, $options = array())
{
 ...
 */
static function input_hidden_tag($name, $value = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function input_file_tag($name, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * @see input_tag
 */
static function input_password_tag($name = 'password', $value = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function textarea_tag($name, $content = null, $options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function checkbox_tag($name, $value = '1', $checked = false, $options = array())
{
 ...
 */
static function radiobutton_tag($name, $value, $checked = false, $options = array())
{
 ...
 * @see input_date_tag
 */
static function input_date_range_tag($name, $value, $options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function input_date_tag($name, $value, $options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function submit_tag($value = 'Save changes', $options = array())
{
 ...
 */
static function reset_tag($value = 'Reset', $options = array())
{
 ...
 */
static function submit_image_tag($source, $options = array())
{
 ...
 */
static function select_day_tag($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('j');
 ...
 * @see select_date_tag, select datetime_tag
 */
static function select_month_tag($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('n');
 ...
 * @see select_date_tag, select datetime_tag
 */
static function select_year_tag($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('Y');
 ...
 */
static function select_date_tag($name, $value = null, $options = array(), $html_options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function select_second_tag($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('s');
 ...
 * @see select_time_tag, select datetime_tag
 */
static function select_minute_tag($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('i');
 ...
 * @see select_time_tag, select datetime_tag
 */
static function select_hour_tag($name, $value = null, $options = array(), $html_options = array())
{
  $options = _parse_attributes($options);
  $select_options = array();
 ...
 * @see select_time_tag, select datetime_tag
 */
static function select_ampm_tag($name, $value = null, $options = array(), $html_options = array())
{
  if ($value === null)
  {
    $value = date('A');
 ...
 */
static function select_time_tag($name, $value = null, $options = array(), $html_options = array())
{
  $options = _parse_attributes($options);
 ...
 */
static function select_datetime_tag($name, $value = null, $options = array(), $html_options = array())
{
  $options = _parse_attributes($options);
 ...
 * @see options_for_select, content_tag
 */
static function select_number_tag($name, $value, $options = array(), $html_options = array())
{
 ...
 */
static function label_for($id, $label, $options = array())
{
  $options = _parse_attributes($options);
 ...
 * @return string <select> tag populated with all the languages in the world.
 */
static function get_id_from_name($name, $value = null)
{
 ...
 */
static function _prepend_zeros($string, $strlen)
{
 ...
 * @see sfUser
 */
static function _get_I18n_date_locales($culture = null)
{
  if (!$culture)
  {
    $culture = sfContext::getInstance()->getUser()->getCulture();
 ...
 */
static function _parse_value_for_date($value, $key, $format_char)
{
  if (is_array($value))
  {
 ...
 */
static function _convert_options($options)
{
  $options = _parse_attributes($options);
 ...
 */
static function _boolean_attribute($options, $attribute)
{
