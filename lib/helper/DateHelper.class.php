 ...
 * @version    SVN: $Id: DateHelper.php 1816 2006-08-24 12:49:01Z fabien $
 */
class DateHelper extends sfHelper
{

static function format_daterange($start_date, $end_date, $format = 'd', $full_text, $start_text, $end_text, $culture = null)
{
...
static function format_date($date, $format = 'd', $culture = null, $charset = null)
{
  if (!$culture) $culture = sfContext::getInstance()->getUser()->getCulture();
...
static function format_datetime($date, $format = 'F', $culture = null, $charset = null)
{
  if (!$culture) $culture = sfContext::getInstance()->getUser()->getCulture();
  if (!$charset) $charset = sfConfig::get('sf_charset');
...
static function distance_of_time_in_words($from_time, $to_time = null, $include_seconds = false)
{
