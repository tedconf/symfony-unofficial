 ...
 * @version    SVN: $Id: PartialHelper.php 2052 2006-09-12 17:51:45Z fabien $
 */
class PartialHelper extends sfHelper
{
 ...
 */
static function include_component_slot($name, $vars = array())
{
 ...
 * @see    get_component_slot, include_partial, include_component
 */
static function get_component_slot($name, $vars = array())
{
 ...
 */
static function include_component($moduleName, $componentName, $vars = array())
{
 ...
 */
static function get_component($moduleName, $componentName, $vars = array())
{
  $context = sfContext::getInstance();
 ...
 */
static function include_partial($templateName, $vars = array())
{
 ...
 * @see    include_partial
 */
static function get_partial($templateName, $vars = array())
{
  $context = sfContext::getInstance();
...
static function _get_cache($cacheManager, $uri)
{
...
static function _set_cache($cacheManager, $uri, $retval)
{
 ...
 */
static function include_slot($name)
{
  echo get_slot($name);
}
