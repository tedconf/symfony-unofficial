<?php
/**
 * $Header: /repository/pear/sfLog/sfLog/mcal.php,v 1.17 2004/01/19 08:02:40 jon Exp $
...
class sfLog_mcal extends sfLog {
    ...
    */
     ...
     * @access public
     */
    function sfLog_mcal($name, $ident = '', $conf = array(),
    ...
    /**
     * sfLogs $message and associated information to the currently open
